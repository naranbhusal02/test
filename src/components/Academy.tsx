...
export default function Academy() {
  ...
  return (
    <section id="academy" className="bg-[#121212] py-24 lg:py-30 relative overflow-hidden">
      <div className="max-w-5xl mx-auto px-6 lg:px-10 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {programs.map((p) => (
            <div
              key={p.title}
              className={`group relative overflow-hidden rounded-xl border bg-[#1c1c1c]/40 flex flex-col justify-between ${
                p.featured
            ...
            >
              <div>
                ...
                <div className="relative h-48 overflow-hidden">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#121212] to-[#121212]/30" />
                  
                  {p.featured && (
                    <span className="absolute top-4 right-4 bg-gold text-forest text-[8px] tracking-[0.2em] uppercase px-2 py-1 rounded font-sans font-semibold">
                      Featured
                    </span>
                  )}
                  <span className="absolute bottom-4 left-4 bg-[#121212]/90 text-gold text-xs tracking-wider font-semibold py-0.5 px-2 rounded border border-gold/15">
                    {p.price}
                  </span>
                </div>
                ...
                <div className="p-6">
                  ...
                  <h3 className="font-serif text-xl text-cream font-light mt-2 mb-3">
                    {p.title}
                  </h3>
                  <p className="text-cream/60 text-xs leading-relaxed font-sans tracking-wide mb-6">
                    {p.desc}
                  </p>
